...
export default function Example() {
  ...
  return (
    <><Head>
      <title>Jacob Yi | Blog</title>
      <meta
        name="description"
        content="Jacob Yi, a full-stack developer, creates dynamic web apps. Passionate about coding, faith, family, travel, and embracing future opportunities." />
